...
if [ "$#" -lt 1 ]; then
  ...
  echo "env overrides: SUBAGENT_RUNNER_BIN / SUBAGENT_RUNNER_WORKDIR / SUBAGENT_IFLOW_TIMEOUT_S / SUBAGENT_IFLOW_IDLE_TIMEOUT_S / SUBAGENT_IFLOW_STALL_GRACE_S / SUBAGENT_IFLOW_KILL_GRACE_MS" >&2
  exit 2
fi
...
STDOUT_PATH="$RUN_DIR/iflow.stdout.log"
STDERR_PATH="$RUN_DIR/iflow.stderr.log"
